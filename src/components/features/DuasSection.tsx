                ...
                <div className="space-y-8 pt-4">
                    <div className="grid gap-6">
                        <div className="space-y-2">
                            ...
                            <input value={newDua.title} onChange={(e) => setNewDua({ ...newDua, title: e.target.value })} className="w-full px-6 py-4 rounded-2xl border-2 border-border dark:border-white dark:[color-scheme:dark] font-black focus:border-[#4a342e] outline-none text-foreground bg-transparent" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-muted-foreground">Arabic Text</label>
                            <textarea value={newDua.arabic} onChange={(e) => setNewDua({ ...newDua, arabic: e.target.value })} className="w-full h-32 px-6 py-4 rounded-2xl border-2 border-border dark:border-white dark:[color-scheme:dark] text-2xl text-right focus:border-[#4a342e] outline-none text-foreground bg-transparent" dir="rtl" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-muted-foreground">Translation</label>
                            <textarea value={newDua.translation} onChange={(e) => setNewDua({ ...newDua, translation: e.target.value })} className="w-full h-32 px-6 py-4 rounded-2xl border-2 border-border dark:border-white dark:[color-scheme:dark] font-bold focus:border-[#4a342e] outline-none text-foreground bg-transparent" />
                        </div>
                    </div>
